package co.dp.registroaxa.Util;
...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(Context context, PickerOptionListener listener) {
        ...
        // add a list
        String[] animals = {MyConstants.TAKE_PIC, MyConstants.SELECT_GALERIA};
...
/*
        ...
        //options.setLogoColor(ContextCompat.getColor(this, R.color.colorAccent));
        options.setCropFrameColor(ContextCompat.getColor(this, R.color.colorAccent));
        //options.setLogoColor(ContextCompat.getColor(this, R.color.colorAccent));
        //options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.colorAccent));
        //options.setRootViewBackgroundColor(ContextCompat.getColor(this, R.color.colorAccent));
        //options.setHideBottomControls(true);
        //options.setDimmedLayerColor(ContextCompat.getColor(this, R.color.colorAccent));
      ...
      //  options.setFreeStyleCropEnabled(true);*/
        ...
        /*Si quieres que sea una imagen cudrada descomenta*/
        if (lockAspectRatio)
